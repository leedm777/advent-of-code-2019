...
(defn o
  [st]
  (first (int-read-output st)))

(deftest day05-test-part2
  (testing "example 1"
    (is (= 0 (o (int-code [3,9,8,9,10,9,4,9,99,-1,8] [7])))))

  (testing "example 1, part 2"
    (is (= 1 (o (int-code [3,9,8,9,10,9,4,9,99,-1,8] [8])))))

  (testing "example 2"
    (is (= 0 (o (int-code [3,9,7,9,10,9,4,9,99,-1,8] [8])))))

  (testing "example 2, part 2"
    (is (= 1 (o (int-code [3,9,7,9,10,9,4,9,99,-1,8] [7])))))

  (testing "example 3"
    (is (= 0 (o (int-code [3,3,1108,-1,8,3,4,3,99] [7])))))

  (testing "example 3, part 2"
    (is (= 1 (o (int-code [3,3,1108,-1,8,3,4,3,99] [8])))))

  (testing "example 4"
    (is (= 0 (o (int-code [3,3,1107,-1,8,3,4,3,99] [8])))))

  (testing "example 4, part 2"
    (is (= 1 (o (int-code [3,3,1107,-1,8,3,4,3,99] [7])))))

  (testing "example 5"
    (is (= 0 (o (int-code [3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9] [0])))))

  (testing "example 5, part 2"
    (is (= 1 (o (int-code [3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9] [8675309])))))

  (testing "example 6"
    (is (= 0 (o (int-code [3,3,1105,-1,9,1101,0,0,12,4,12,99,1] [0])))))

  (testing "example 6, part 2"
    (is (= 1 (o (int-code [3,3,1105,-1,9,1101,0,0,12,4,12,99,1] [8675309])))))

  (testing "example 7"
    (is (= 999 (o (int-code [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
                             1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
                             999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99] [7])))))

  (testing "example 7, part 2"
    (is (= 1000 (o (int-code [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
                              1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
                              999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99] [8])))))

  (testing "example 7, part 3"
    (is (= 1001 (o (int-code [3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
                              1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
...
(deftest day09-part1
  ...
  (testing "example 2"
    (is (= 1219070632396864 (o (int-code [1102,34915192,34915192,7,4,7,99,0])))))

  (testing "example 3"
    (is (= 1125899906842624 (o (int-code [104,1125899906842624,99]))))))
